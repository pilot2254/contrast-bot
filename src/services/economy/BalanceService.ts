...
export class BalanceService {
  ...
  async transferBalance(
    ...
    return await this.client.database.transaction(async () => {
      ...
      const senderBalance = await this.removeBalance(senderId, amount, `Transfer to ${receiverId}`)
      const receiverBalance = await this.addBalance(receiverId, amount, `Transfer from ${senderId}`)
